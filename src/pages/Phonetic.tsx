...
const Phonetic = () => {
  ...
  const handleConvert = () => {
    ...
    // Replace all occurrences of dictionary words with their meanings in "value (key)" format
    sortedWords.forEach(word => {
      ...
      if (meaning) {
        ...
        // Format as "meaning (original_word)"
        convertedText = convertedText.replace(regex, `${meaning} (${word})`);
      }
    });
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-blue-600">Phonetic Converter</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md border border-blue-200">
          ...
          <div className="space-y-4">
            <Textarea
              placeholder="Enter your text to convert words with phonetic format"
              value={inputText}
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-blue-200">
          ...
          <Textarea
            ...
            placeholder="Converted text with phonetic format will appear here"
          />
        </div>
      </div>
    </div>
